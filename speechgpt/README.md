# Speech-GPT-Zen: Complete Setup Guide (Updated & Tested)
...
# 2. CREATE FRESH ENVIRONMENT WITH EXACT WORKING VERSIONS
conda create -n speechgpt python=3.8 -y
conda activate speechgpt

# 3. INSTALL CUDA 11.7 TOOLKIT (available version)
conda install cudatoolkit=11.7 -c conda-forge -y

# 4. INSTALL PYTORCH WITH CUDA 11.7 (available versions)
...
# 5. DOWNGRADE PIP FOR COMPATIBILITY
python -m pip install "pip<24.1"

# 6. INSTALL BITSANDBYTES (compatible with CUDA 11.7)
...
# 8. INSTALL SPEECHGPT REQUIREMENTS
pip install -r requirements.txt

# 9. SETUP PYTHON PACKAGE
cat > setup.py << 'EOF'
from setuptools import setup, find_packages
setup(name="speechgpt", version="0.1.0", packages=find_packages())
EOF

# 11. create these files
touch __init__.py
touch src/__init__.py
touch src/infer/__init__.py
touch utils/__init__.py
touch utils/speech2unit/__init__.py
